      ...
      <Section>
        <Reveal className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-4 text-lg leading-relaxed text-neutral-700 text-justify">
            تستند أسرة آل معجب آل يحيى الشريف إلى تاريخٍ ممتدٍّ وجذورٍ متصلة بآل البيت الكرام؛ إذ يعود نسبهم إلى الأشراف الرسيين الحسنيين من آل شيبان.
          </p>
          <p className="mt-4 text-lg leading-relaxed text-neutral-700 text-justify">
            شهد مطلع القرن الحادي عشر الهجري محطة استقرار جدهم الأول، الشريف يحيى بن إدريس، في محافظة الأفلاج بمنطقة الرياض. ومن تلك المحافظة العريقة، امتدت فروع الأسرة وتوسعت لتنتشر في العاصمة الرياض ومختلف محافظاتها، حاملةً معها القيم الأصيلة وتاريخاً من التآلف والترابط.
          </p>
          <p className="mt-4 text-lg leading-relaxed text-neutral-700 text-justify">
            وعبر العقود، عُرِفت الأسرة بمكانتها الاجتماعية ووجاهتها، وبرز من أبنائها عبر الأجيال رجالات قضاء وشخصيات وطنية ومسؤولون ساهموا بفاعلية في خدمة الدين والوطن والمجتمع، ومواصلة مسيرة العطاء في شتى المجالات العلمية والمهنية.
          </p>
        </Reveal>
      </Section>
